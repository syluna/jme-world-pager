...
public class GridPos3i implements Cloneable {
    ...
    public static GridPos3i fromWorldLocation(Vector3f worldLocation, int bitshift) {
        return new GridPos3i((int)worldLocation.x >> bitshift, (int)worldLocation.y >> bitshift, (int)worldLocation.z >> bitshift, bitshift);
    }
    ...
    public Vector3f toWorldTranslation() {
        return new Vector3f((float)(this.x << this.bitshift), (float)(this.y << this.bitshift), (float)(this.z << this.bitshift));
    }
